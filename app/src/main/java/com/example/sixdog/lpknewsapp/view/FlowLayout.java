package com.example.sixdog.lpknewsapp.view;
...
//        invalidate();
    ...
    public void onClick(View v) {
        ...
        if(flowRemove!=null){
            flowRemove.changeSpf(set);
        }
        removeView(v);

    }
    private FlowRemove flowRemove;

    public FlowRemove getFlowRemove() {
        return flowRemove;
    }

    public void setFlowRemove(FlowRemove flowRemove) {
        this.flowRemove = flowRemove;
    }

    public interface  FlowRemove{
        void changeSpf(Set<String> set);
    }
}
