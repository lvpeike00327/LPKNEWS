 ...
 */
public  abstract  class BaseLoadAdapter<T>  extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {

    public static final String TAG = "BaseLoadingAdapter";
    ...
    public BaseLoadAdapter(RecyclerView recyclerView, List<T> ts) {
